...
fun DetailsScreen(
    ...
    // It launches a coroutine scoped to the Composition
    // that can push values into the returned State using the value property.
    //
    // As with LaunchedEffect, produceState also takes keys
    // to cancel and restart the computation.
